...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~uRpWhJjS#Hb3EZEuakvuiLMQxs-aaf2MgeOS_ONEno6Ze5ws0WtM",
    CAPTION: process.env.CAPTION || "MRɳƬ_AFRIKEN UNLOCKER PRO ⚡",
    ...
    OWNER_NAME: process.env.OWNER_NAME || "➺Mr AFRIKEN ɳƬ_UNLOCKER࿐",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "➺MR⚡AFRIKEN🤗UNLOCKERPRO",
